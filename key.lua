...
GetKey.MouseButton1Click:Connect(function()
   setclipboard("2683408667")
end)

local function validateKey(key)
    return key == "Sumi707070" -- 将此替换为您的密钥
end
...
-- 将您的脚本放在此处
loadstring(game:HttpGet('https://raw.githubusercontent.com/fishnnnvvv/Sumi/main/SumiHub.lua'))()
