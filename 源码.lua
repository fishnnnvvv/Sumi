if loadstring(game:HttpGet "https://pastebin.com/raw/SKQ4yd4e")() ~= 'This is the Hasl script UI to prevent theft' then
    while wait() do
        print('你个傻逼还想盗用Hasl的UI')
    end
end
repeat
    wait()
...
local Theme = {
    RedTheme = {
        ...
        MainHeaderColor = Color3.fromRGB(141, 56, 56),
        MainHeaderColorImage = Color3.fromRGB(130, 51, 51),
        TainerHdlderColor = Color3.fromRGB(36, 36, 36),
        NewPageColor = Color3.fromRGB(193, 76, 76),
        SectionMainColor = Color3.fromRGB(32, 32, 32),
        Color = Color3.fromRGB(141, 56, 56),
        Image = Color3.fromRGB(130, 51, 51),
        MouseEnterColor = Color3.fromRGB(121, 48, 48),
        TextBoxColor = Color3.fromRGB(109, 43, 43),
        FontColor = Color3.fromRGB(255, 101, 101),
        SliderButtonColor = Color3.fromRGB(141, 56, 56),
        SliderColor = Color3.fromRGB(109, 43, 43),
        DropOpenColor = Color3.fromRGB(141, 56, 56),
        DropImageColor = Color3.fromRGB(235, 93, 93),
        DropFrameColor = Color3.fromRGB(84, 33, 33),
        SampleColor = Color3.fromRGB(36, 36, 36),
        SeperatorColor = Color3.fromRGB(141, 56, 56)
    },
    DarkTheme = {
        MainColor = Color3.fromRGB(36, 36, 36),
        MainHeaderColor = Color3.fromRGB(30, 30, 29),
        MainHeaderColorImage = Color3.fromRGB(27, 27, 27),
        TainerHdlderColor = Color3.fromRGB(36, 36, 36),
        NewPageColor = Color3.fromRGB(95, 95, 95),
        SectionMainColor = Color3.fromRGB(32, 32, 32),
        Color = Color3.fromRGB(36, 36, 36),
        Image = Color3.fromRGB(30, 30, 30),
        MouseEnterColor = Color3.fromRGB(45, 45, 45),
        TextBoxColor = Color3.fromRGB(30, 30, 30),
        FontColor = Color3.fromRGB(255, 255, 255),
        SliderButtonColor = Color3.fromRGB(26, 26, 26),
        SliderColor = Color3.fromRGB(255, 255, 255),
        DropOpenColor = Color3.fromRGB(36, 36, 36),
        DropImageColor = Color3.fromRGB(255, 255, 255),
        DropFrameColor = Color3.fromRGB(26, 26, 26),
        SampleColor = Color3.fromRGB(36, 36, 36),
        SeperatorColor = Color3.fromRGB(95, 95, 95)
    }
}
...
function Forums.new(Themes, close_callback)
    if not Themes then
        Themes = Theme.RedTheme
    end
    if Themes == "RedTheme" then
        Themes = Theme.RedTheme
    elseif Themes == "DarkTheme" then
    ...
    Open.MouseEnter:Connect(function()
        game.TweenService:Create(Open, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
            ImageTransparency = 0
        }):Play()
    end)
    ...
    header.Name = "header"
    header.Parent = Main
    header.BackgroundColor3 = Themes.MainHeaderColor
    ...
    triangle1.ImageColor3 = Themes.MainHeaderColorImage
    ...
    triangle.ImageColor3 = Themes.MainHeaderColorImage

    close_callback = close_callback or function() end
    close.Name = "close"
    close.Parent = header
    ...
    containerHolder.BackgroundColor3 = Themes.TainerHdlderColor
    ...
    newPage.ScrollBarImageColor3 = Themes.NewPageColor
    ...
    function sections:NewSection(title)
        ...
        sectionMain.BackgroundColor3 = Themes.SectionMainColor
        ...
        btn.MouseButton1Click:Connect(function()
            if opened then
                game.TweenService:Create(sectionMain,
        ...
        btn.MouseEnter:Connect(function()
            game.TweenService:Create(sectionTitle,
                TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
        ...
        function fElements:NewButton(title, callback)
            ...
            btnFrame.BackgroundColor3 = Themes.Color
            ...
            triangle.ZIndex = 5
            triangle.Image = "http://www.roblox.com/asset/?id=6676220228"
            triangle.ImageColor3 = Themes.Image
            ...
            Sample.ImageColor3 = Themes.SampleColor
            ...
            btn.MouseEnter:Connect(function()
                game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                    {
                        BackgroundColor3 = Themes.MouseEnterColor
                    }):Play()
            end)
            btn.MouseLeave:Connect(function()
                game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                    {
                        BackgroundColor3 = Themes.Color
                    }):Play()
            end)
            function ButtonFunctions:Update(textB)
                if btnText.Text ~= textB then
                    game.TweenService:Create(btnText,
        ...
        function fElements:NewToggle(title, callback)
            ...
            toggleFrame.BackgroundColor3 = Themes.Color
            ...
            btn.MouseButton1Click:Connect(function()
                if toggled then
                    game.TweenService:Create(checked,
                        TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
                            Size = UDim2.new(0, 20, 0, 20)
                        }):Play()
                    game.TweenService:Create(unchecked,
                        TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
                            Size = UDim2.new(0, 20, 0, 20)
                        }):Play()
                    wait(0.08)
                ...
                game.TweenService:Create(circle,
            ...
            function ToggleFunctions:Update(textT)
                if toggleFrame_2.Text ~= textT then
                    game.TweenService:Create(toggleFrame_2,
                        TweenInfo.new(0.14, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            TextTransparency = 1
                        }):Play()
                    wait(0.14)
        ...
        function fElements:NewTextBox(title, callback)
            ...
            textboxFrame.BackgroundColor3 = Themes.Color
            ...
            txtbox.BackgroundColor3 = Themes.TextBoxColor
            txtbox.BorderColor3 = Themes.TextBoxColor
            txtbox.Position = UDim2.new(0.549000025, 0, 0.172999993, 0)
            txtbox.Size = UDim2.new(0, 176, 0, 20)

            TextBox.Parent = txtbox
            TextBox.BackgroundColor3 = Themes.TextBoxColor
            TextBox.BorderColor3 = Themes.TextBoxColor
            ...
            TextBox.PlaceholderColor3 = Themes.FontColor
            ...
            function BoxFunctions:Update(textB)
                if txtboxText.Text ~= textB then
                    game.TweenService:Create(txtboxText,
                        TweenInfo.new(0.14, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            TextTransparency = 1
                        }):Play()
                    wait(0.14)
        ...
        function fElements:NewSlider(title, minvalue, maxvalue, callback)
            ...
            sliderFrame.BackgroundColor3 = Themes.Color
            ...
            sliderText_2.TextColor3 = Themes.FontColor
            sliderText_2.TextSize = 14.000
            sliderText_2.TextXAlignment = Enum.TextXAlignment.Right

            SliderButton.Name = "SliderButton"
            SliderButton.Parent = sliderFrame
            SliderButton.BackgroundColor3 = Themes.SliderButtonColor
            SliderButton.BorderColor3 = Themes.SliderButtonColor
            ...
            sliderDrag.BackgroundColor3 = Themes.SliderColor
            ...
            SliderButton.MouseButton1Down:Connect(function()
                Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 215) * sliderDrag.AbsoluteSize.X) +
                    tonumber(minvalue)) or 0
                pcall(function()
                    callback(Value)
                end)
                sliderDrag:TweenSize(UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X, 0, 215), 0, 8),
                    "InOut", "Linear", 0.05, true)
                moveconnection = mouse.Move:Connect(function()
                    ...
                    sliderDrag:TweenSize(
                        UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X, 0, 215), 0, 8),
                        "InOut", "Linear", 0.05, true)
                end)
                releaseconnection = uis.InputEnded:Connect(function(Mouse)
                    if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        sliderText_2.Text = Value
                        sliderDrag:TweenSize(
                            UDim2.new(0, math.clamp(mouse.X - sliderDrag.AbsolutePosition.X, 0, 215), 0, 8), "InOut",
                            "Linear", 0.05, true)
        ...
        function fElements:NewKeybind(title, currentKey, callback)
            ...
            keybindFrame.BackgroundColor3 = Themes.Color
            ...
            btn.MouseButton1Click:Connect(function()
                game.TweenService:Create(currentKey,
                    TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                        TextTransparency = 1
                    }):Play()
                wait(0.14)
        ...
        function fElements:NewDropdown(title, list, callback)
            ...
            dropFrame.BackgroundColor3 = Themes.DropFrameColor
            ...
            dropOpen.BackgroundColor3 = Themes.DropOpenColor
            ...
            dropOpen.MouseButton1Click:Connect(function()
                if dOpened then
                    dOpened = false
                    game.TweenService:Create(dropFrame,
                        TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            Size = UDim2.new(0, 474, 0, 32)
                        }):Play()
                    game.TweenService:Create(expand_more,
                        TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            Rotation = 0
                        }):Play()
                    wait(0.1)
                    game.TweenService:Create(sectionMain,
                        TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                            Size = UDim2.new(0, itemsList.AbsoluteContentSize.X, 0,
                                itemsList.AbsoluteContentSize.Y + 5)
                        }):Play()
                else
                    dOpened = true
                    game.TweenService:Create(dropFrame,
            ...
            dropOpen.MouseEnter:Connect(function()
                game.TweenService:Create(dropOpen,
                    TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                        BackgroundColor3 = Themes.MouseEnterColor
                    }):Play()
            end)
            ...
            expand_more.ImageColor3 = Themes.DropImageColor
            ...
            for i, v in next, list do
                ...
                dropOption.BackgroundColor3 = Themes.Color
                ...
                Sample_2.ImageColor3 = Themes.SampleColor
        ...
        function fElements:Seperator()
            ...
            seperator.BackgroundColor3 = Themes.SeperatorColor
